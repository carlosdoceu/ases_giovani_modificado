...
dic_columns = ['TIPO','Link','Porcentagem','Apuracao','Marcacao', 'Comportamento','Conteudo/informacao','Apresentacao/Design','Multimidia','Formularios','Total Erros','Total Avisos']
dicio_rows = ['PRODUCAO']
...
for url in urls:
    ...
    for percent_data in range(1, percentage + 1):
        percent.append(navegador.find_element(By.XPATH, "//*[@id='webaxscore']/span[" + str(percent) + "]").text)
    percent[0]
